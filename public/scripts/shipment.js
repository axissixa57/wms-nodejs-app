(async function bootstrap() {
  ...
  if (warehouses) {
    ...
    const warehouseModalScrollable = document.getElementById(
      'warehouseModalScrollable'
    );
  ...
  if (consignees) {
    ...
    const receiverOfGoodsModalScrollable = document.getElementById(
      'receiverOfGoodsModalScrollable'
    );
...
function countTotalWeight() {
  ...
  for (let i = 0; i < trsMainTable.length; i++) {
    ...
    const quantity = parseInt(
      trsMainTable[i].children[3].children[0].children[0].value
    );
...
function GetConsignees() {
  $.ajax({
    ...
    success: function(consignees) {
      ...
      const consigneesALL = document.querySelectorAll(
        '#all_consignees tbody tr'
      );
      const consigneeID = document.getElementById('consignee_id');
      const btnConsignees = document.getElementById('btnConsignees');
      const receiverOfGoodsModalScrollable = document.getElementById(
